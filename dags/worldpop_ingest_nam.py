...
RAW_URL = "https://data.worldpop.org/GIS/Population/Global_2015_2030/R2025A/2025/NAM/v1/100m/constrained/nam_pop_2025_CN_100m_R2025A_v1.tif"
...
RAW_PATH = str(DATA_DIR / "nam_pop_2025_CN_100m_R2025A_v1.tif")
WM_PATH  = str(DATA_DIR / "nam_pop_2025_CN_100m_R2025A_v1_3857.tif")
COG_PATH = str(DATA_DIR / "nam_pop_2025_CN_100m_R2025A_v1_cog.tif")
...
def _year_paths(year: int):
    raw = str(DATA_DIR / f"nam_pop_{year}_CN_100m_R2025A_v1.tif")
    wm = str(DATA_DIR / f"nam_pop_{year}_CN_100m_R2025A_v1_3857.tif")
    cog = str(DATA_DIR / f"nam_pop_{year}_CN_100m_R2025A_v1_cog.tif")
    return raw, wm, cog


def _year_url(year: int) -> str:
    return f"https://data.worldpop.org/GIS/Population/Global_2015_2030/R2025A/{year}/NAM/v1/100m/constrained/nam_pop_{year}_CN_100m_R2025A_v1.tif"
...
with DAG(
    dag_id="worldpop_ingest_cog_nam",
